    ...
    <div className="min-h-screen bg-dot-matrix flex flex-col">
      ...
      <div className="flex-1">
        <div className="container mx-auto px-4 py-8">
          ...
          {/* View Mode Toggle */}
          <div className="relative flex justify-center items-center gap-4 mb-6 flex-wrap">
            {/* Connection Status */}
            <div
              className={`absolute left-0 px-3 py-1 rounded-full text-xs ${isConnected ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}
            >
              ...
              <nav className="flex space-x-8 overflow-x-auto px-2">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === tab.id ? '' : 'border-transparent text-muted hover:text-white'
                      }`}
                    style={
