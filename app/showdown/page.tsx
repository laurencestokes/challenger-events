        ...
        <section className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-black py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Where anyone can compete against anyone. No barriers. No excuses. Just pure
              performance.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  The Showdown is a revolutionary fitness competition that eliminates traditional
                  categories and divisions. Using our Challenger Score system, athletes of all
                  sizes, ages, and backgrounds compete on a truly level playing field.
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  Whether you&apos;re a powerlifter, CrossFit athlete, or weekend warrior, your
                  performance is measured purely on output, not demographics.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Powerlifting-style events with normalized scoring based on body weight and
                  demographics.
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Multi-modal challenges that test strength, endurance, and tactical
                  decision-making.
                </p>
              </div>
            </div>
