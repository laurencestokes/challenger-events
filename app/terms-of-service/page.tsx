    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 container mx-auto px-4 py-8">
        <div className="panel rounded-2xl p-6 ">
          ...
          <div className="prose prose-lg max-w-none [&_strong]:text-tactical">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">4. Prohibited Uses</h2>
              <p className="text-text-secondary mb-4">You may not use our service:</p>
              <ul className="list-disc pl-6 text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">5. Content</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Privacy Policy</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">7. Termination</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">8. Disclaimer</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">10. Changes</h2>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="bg-surface-high p-4 rounded-lg">
