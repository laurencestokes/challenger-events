        ...
        <div className="panel rounded-2xl p-6 ">
          ...
          <div className="prose prose-lg max-w-none [&_strong]:text-tactical">
            ...
            <section className="mb-8">
              ...
              <p className="text-text-secondary mb-4">We use cookies for several purposes:</p>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">Cookie Consent</h3>
              <p className="text-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-text-primary mb-4">6. Cookie Duration</h2>
              <p className="text-text-secondary mb-4">
