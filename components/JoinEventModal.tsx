        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center">
              <FiCalendar className="w-5 h-5 text-primary-light" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              maxLength={10}
            />
            <p className="text-muted text-xs mt-1">Ask your event organizer for the event code</p>
          </div>
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              ...
              className="flex-1 px-4 py-3 bg-primary text-white rounded-lg hover:bg-primary disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center space-x-2"
            >
              {isLoading ? (
                <>
