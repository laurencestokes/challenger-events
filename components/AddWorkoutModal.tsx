...
export default function AddWorkoutModal({
  ...
  const [type, setType] = useState<'TIME' | 'REPS' | 'WEIGHT' | 'DISTANCE' | 'CUSTOM'>('WEIGHT');
  const [scoringSystemId, setScoringSystemId] = useState<string>('');
  ...
  const handleTypeChange = (newType: 'TIME' | 'REPS' | 'WEIGHT' | 'DISTANCE' | 'CUSTOM') => {
    setType(newType);
    setScoringSystemId(''); // Reset scoring system when type changes
