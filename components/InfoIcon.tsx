...
export default function InfoIcon({ tooltip, className = '' }: InfoIconProps) {
  ...
  return (
    <div className="relative inline-block">
      <div
        className={`inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-600/50 border border-gray-500 text-text-secondary text-xs cursor-help leading-none hover:bg-surface-high0/50 hover:border-gray-400 transition-colors ${className}`}
