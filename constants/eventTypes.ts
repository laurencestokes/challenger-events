...
export const EVENT_TYPES: EventType[] = [
  ...
  },
  {
    id: 'bike_10km',
    name: '10km Bike',
    description: '10km bike with scoring based on time, age, and sex',
    category: 'ENDURANCE',
    scoringSystemId: 'bike_10km',
    inputType: 'TIME',
    unit: 'seconds',
    supportsReps: false,
  },
  {
    id: 'ski_1km',
    name: '1km Ski',
    description: '1km ski with scoring based on time, age, and sex',
    category: 'ENDURANCE',
    scoringSystemId: 'ski_1km',
    inputType: 'TIME',
    unit: 'seconds',
    supportsReps: false,
  },
  {
    id: 'running_1mile',
    name: '1 Mile Run',
    description: '1 mile running with scoring based on time, age, and sex',
    category: 'ENDURANCE',
    scoringSystemId: 'running_1mile',
    inputType: 'TIME',
    unit: 'seconds',
    supportsReps: false,
  },
