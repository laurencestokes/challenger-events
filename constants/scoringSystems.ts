...
export const SCORING_SYSTEMS: ScoringSystem[] = [
  ...
  },
  {
    id: 'bike_10km',
    name: '10km Bike',
    description: '10km bike scoring based on time, age, and sex',
    category: 'ENDURANCE',
    inputType: 'TIME',
    unit: 'seconds',
    requiresBodyweight: false,
    requiresAge: true,
    requiresSex: true,
    calculationFunction: 'bike10kmScore',
  },
  {
    id: 'ski_1km',
    name: '1km Ski',
    description: '1km ski scoring based on time, age, and sex',
    category: 'ENDURANCE',
    inputType: 'TIME',
    unit: 'seconds',
    requiresBodyweight: false,
    requiresAge: true,
    requiresSex: true,
    calculationFunction: 'ski1kmScore',
  },
  {
    id: 'running_1mile',
    name: '1 Mile Run',
